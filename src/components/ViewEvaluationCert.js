    ...
    <div className="p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-100 p-4 rounded-lg border border-gray-300 shadow-sm hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold flex items-center">
              <HiOutlineEye className="mr-2 text-blue-500" /> View Students Grades
            </h3>
      ...
      >
        Show Grades
          ...
          <div className="bg-gray-100 p-4 rounded-lg border border-gray-300 shadow-sm hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold flex items-center">
              <HiClipboardList className="mr-2 text-green-500" /> View Courses
            </h3>
...
{isCoursesModalOpen && (
  <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
    <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 sm:w-1/3">
      <h2 className="text-xl font-semibold mb-4">Select Year Level</h2>
      ...
      <button
        className="mt-4 w-full bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400 transition duration-200"
        onClick={closeModal}
      >
        Close
      </button>
            ...
            <li key={index} className="flex justify-between items-center p-2 border-b border-gray-200">
              ...
              <div className="flex space-x-2">
                ...
                <a
                  ...
                  className="text-blue-600 underline hidden" // Keep link for accessibility
                >
                  Open
                </a>
              </div>
...
{showStudentsTable && ( 
  <div className="mt-6 bg-white p-4 rounded-lg shadow max-h-90 overflow-hidden"> 
    ...
    {loadingStudents ? (
      ...
      <div className={`overflow-auto ${filteredStudents.length > 4 ? 'max-h-80' : 'max-h-full'}`}>
...
{isCourseFilesModalOpen && ( // Modal state variable
  <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-70 z-50">
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full transition-transform transform scale-100 hover:scale-105">
      <h3 className="text-2xl font-bold mb-6 text-center text-gray-800 flex items-center justify-center">
        <HiEye className="mr-2 text-blue-600" /> Uploaded Course Files
      </h3>
      {loadingCourseFiles ? ( // Loading state for course files
