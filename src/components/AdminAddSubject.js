  ...
  return (
    <div className="p-5">
     ...
     <div className="bg-white rounded-lg shadow-md p-5 mb-4">
        <h2 className="text-2xl font-semibold mb-3">Subject Management</h2>
        <p className="mb-4 text-gray-700">
          Manage subjects efficiently. Add new subjects and view existing subjects for each year level.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {["1st", "2nd", "3rd", "4th"].map((level) => (
            <div
              key={level}
              className="bg-gray-100 p-4 rounded-lg border border-gray-300 shadow-sm hover:shadow-lg transition-shadow"
            >
              <h3 className="text-xl font-semibold flex items-center">
                <HiPlus className="mr-2 text-green-500" /> Add {level} Year Subject
              </h3>
              <button
              ...
              <div className="max-w-md mx-auto mt-6 p-6 bg-gray-300 rounded-lg shadow-md">
  <h3 className="text-2xl font-bold flex items-center mb-4 justify-center">
    <HiOutlineEye className="mr-3 text-blue-600" />
    Show Subjects
  </h3>
  <div className="flex justify-center space-x-4 mt-2">
    <button
      className="bg-blue-600 text-white px-5 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-200 transform hover:scale-105"
      onClick={() => handleShowSubjects(level, "1st")}
    >
      1st Sem
    </button>
    <button
      className="bg-orange-600 text-white px-5 py-2 rounded-lg shadow-md hover:bg-orange-700 transition duration-200 transform hover:scale-105"
    ...
    >
     ...
     <div className="flex justify-between items-center mb-3">
        <h2 className="text-2xl font-semibold">Display Subjects</h2>
        <button
...
>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg">
      <h2 className="text-xl font-semibold text-center mb-4">Add Subject for {yearLevel} Year</h2>
      {semester ? (
        <div>
          <h3 className="text-lg font-semibold mb-2">Selected Semester: {semester}</h3>
          <div className="space-y-4">
            ...
            >
              Cancel
                ...
                <div className="space-y-4">
  <h3 className="text-lg font-bold text-center mb-4">Select Semester</h3>

  <div className="grid grid-cols-1 gap-4">
    <button
      onClick={() => { setSemester("1st"); }}
      className="flex items-center justify-center bg-green-500 text-white px-6 py-4 rounded-lg shadow-md hover:bg-green-600"
    >
    ...
    <button
      ...
      className="flex items-center justify-center bg-blue-500 text-white px-6 py-4 rounded-lg shadow-md hover:bg-blue-600"
    >
    ...
    <button
      ...
      className="flex items-center justify-center w-full bg-red-600 text-white px-6 py-4 rounded-lg shadow-md hover:bg-red-700"
    >
